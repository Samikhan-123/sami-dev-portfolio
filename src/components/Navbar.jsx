...
function NavBar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${isScrolled ? "glass-nav py-3" : "bg-transparent py-5"}`}
    >
            ...
            >
              {({ isActive }) => (
                <span className="relative flex items-center gap-2">
                  <span
                    className={`opacity-70 ${isActive ? "text-sapphire" : ""}`}
                  >
                    {link.icon}
                  </span>
                  {link.name}
            ...
            <div className="flex flex-col p-8 gap-6">
              {navLinks.map((link) => (
                ...
                >
                  {({ isActive }) => (
                    <>
                      <span className={isActive ? "text-sapphire" : ""}>
                        {link.icon}
                      </span>
                      {link.name}
                    </>
